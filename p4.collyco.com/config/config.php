...
# What is the name of this app?
	define('APP_NAME', 'Bubbles');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'curtiscolly@yahoo.com'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'curtiscolly@yahoo.com'); 

# Default DB name for this app
	define('DB_NAME', "collycoc_accessories"); 
...
define('SMTP_USERNAME', 'curtiscolly@gmail.com');
define('SMTP_PASSWORD', 'mcse1a');



# For extra security, you might want to set different salts than what the core uses
	//define('PASSWORD_SALT', 'icosidodecahedron');
	//define('TOKEN_SALT', 'whambamthankyoumam');